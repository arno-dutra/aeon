...
__author__ = ["Arno Dutra", "James-Large", "AurumnPegasus", "hadifawaz1999"]
...
class FCNDecoderNetwork(BaseDeepNetwork):
    """
    Establish the network structure for a FCN Decoder.
    ...
    def __init__(
        ...
        super(FCNDecoderNetwork, self).__init__()
    ...
    def build_network(self, input_layer, **kwargs):
        ...
        self._n_filters_ = [1, 128, 256] if self.n_filters is None else self.n_filters
        ...
        for i in range(self.n_layers):
            ...
            deconv = tf.keras.layers.Activation(activation=self._activation[i])(deconv)
